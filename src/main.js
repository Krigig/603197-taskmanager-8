...
const getFilterElement = function (caption, amount, isChecked, isDisabled) {
  return `
    <input
      type="radio"
...
const getCardElement = function (colorBar = black, text = '', isDeadline = false, isRepeat = false, hasPhoto = false) {
  return `
