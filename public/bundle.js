...
const renderFilterElements = function (array) {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    let newFilterElement = Object(_make_filter_js__WEBPACK_IMPORTED_MODULE_0__["default"])(element, Math.round(Math.random() * 300), checked, disabled);
...
const renderCardElements = function (amount) {
  for (let i = 0; i < amount; i++) {
    document.querySelector(`.board__tasks`).insertAdjacentHTML(`beforeend`, Object(_make_card_js__WEBPACK_IMPORTED_MODULE_1__["default"])(`black`, `It is example of repeating task. It marks by wave.`));
  }
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ((colorBar = `black`, text = ``, isDeadline = false, isRepeat = false, hasPhoto = false) => `
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ((caption, amount, isChecked, isDisabled) => `<input
      type="radio"
